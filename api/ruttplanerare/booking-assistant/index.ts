...
/**
 * ✅ HELT NY: Genererar ett fåtal strategiska förslag istället för en lång lista.
 */
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  try {
    ...
    const staffToSearch = selectedTechnicianIds?.length > 0
    ...
    console.error("Fel i bokningsassistent (v6.3):", error);

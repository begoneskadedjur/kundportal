// src/pages/admin/TechnicianManagement.tsx - KOMPLETT CRUD FÖR TEKNIKER
import { useState, useEffect } from 'react'
import { useNavigate } from 'react-router-dom'
import { 
  Plus, Search, Filter, User, Mail, Phone, MapPin, 
  Edit, Trash2, Power, UserCheck, Users, MoreVertical, ArrowLeft
} from 'lucide-react'
    ...
    <Card className={`transition-all ${!technician.is_active ? 'opacity-60' : ''}`}>
      ...
      <div className="space-y-2 text-sm">
        <div className="flex items-center gap-2">
          ...
          <a href={`mailto:${technician.email}`} className="text-slate-300 hover:text-white">
            {technician.email}
          </a>
        </div>
        ...
        {technician.direct_phone && (
          <div className="flex items-center gap-2">
            ...
            >
              {technicianService.formatPhoneForDisplay(technician.direct_phone)} (direkt)
            </a>
          </div>
        )}
        ...
        {technician.office_phone && (
          <div className="flex items-center gap-2">
            ...
            <a 
              ...
              className="text-slate-300 hover:text-white"
            >
              {technicianService.formatPhoneForDisplay(technician.office_phone)} (kontor)
            </a>
          </div>
        )}
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-400 text-sm">Hantera alla tekniker och deras information</p>
                </div>
              </div>
            </div>
          </div>

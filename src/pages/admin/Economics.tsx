      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="flex items-center gap-4"><Button variant="secondary" size="sm" onClick={() => navigateMonth('prev')}><ChevronLeft className="w-4 h-4" /> Föregående månad</Button><span className="text-white font-medium">{formatMonth(selectedMonth)}</span><Button variant="secondary" size="sm" onClick={() => navigateMonth('next')}>Nästa månad <ChevronRight className="w-4 h-4" /></Button></div>
          </div>
          <Card className="mb-6">

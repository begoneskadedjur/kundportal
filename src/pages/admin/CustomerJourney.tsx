...
export default function CustomerJourney() {
  ...
  const stages = useMemo((): JourneyStage[] => {
    ...
    // Mutually exclusive branches from "created" — contracts take precedence
    ...
    // Sub-branches within contract flow
  ...
  const kpis = useMemo(() => {
    ...
    return { total, directRate, offerAcceptRate, contractAcceptRate, noResultCount, totalValue }
  }, [stages])

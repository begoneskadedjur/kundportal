        ...
        <Card className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <motion.button
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
              onClick={() => navigate('/technician/leads')}
              className="p-4 bg-gradient-to-br from-amber-500/20 to-orange-600/20 border border-amber-500/30 rounded-lg hover:from-amber-500/30 hover:to-orange-600/30 transition-all group"
            >
              <div className="flex items-center gap-3">
                <motion.div
                  whileHover={{ rotate: 10 }}
                ...
                <div className="text-left"><p className="font-medium text-white">Leads</p><p className="text-amber-300 text-sm">Mina tilldelade leads</p></div>
            ...
            <motion.button
              ...
              className="p-4 bg-gradient-to-br from-emerald-500/20 to-teal-600/20 border border-emerald-500/30 rounded-lg hover:from-emerald-500/30 hover:to-teal-600/30 transition-all group"
            >
              <div className="flex items-center gap-3">
                <motion.div
                  whileHover={{ rotate: 10 }}
                  className="w-10 h-10 bg-emerald-500/20 rounded-full flex items-center justify-center group-hover:bg-emerald-500/30 transition-colors"
                >

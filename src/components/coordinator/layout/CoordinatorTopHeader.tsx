...
interface CoordinatorTopHeaderProps {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <Link to="/koordinator/tickets" className="p-2 rounded-lg text-slate-400 hover:text-white hover:bg-slate-800/50 transition-colors relative" aria-label="Notifieringar">

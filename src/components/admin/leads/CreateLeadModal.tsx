...
export default function CreateLeadModal({ isOpen, onClose, onSuccess }: CreateLeadModalProps) {
  ...
  return (
    ...
    >
      <div className="p-4">
        <form id="create-lead-form" onSubmit={handleSubmit} className="space-y-3">
          ...
          <div className={`p-3 bg-slate-800/30 rounded-xl border ${
          ...
          {/* Företagsinformation */}
          <div className={`p-3 bg-slate-800/30 rounded-xl border ${errors.website ? 'border-red-500/50' : 'border-slate-700'}`}>
            <h3 className={`text-sm font-semibold mb-2 flex items-center gap-1.5 ${errors.website ? 'text-red-300' : 'text-white'}`}>
              <Building2 className={`w-4 h-4 ${errors.website ? 'text-red-400' : 'text-blue-400'}`} />
              Företagsinformation
              {errors.website && (
                <AlertCircle className="w-4 h-4 text-red-400 ml-2" />
              )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              <div className="md:col-span-2 border-t border-slate-700/50 pt-3 mt-1">
                <h4 className="text-xs font-medium text-slate-400 mb-1">Anteckningar</h4>
                <textarea
          ...
          <div className="p-3 bg-slate-800/30 border border-slate-700 rounded-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              <div className="space-y-3">
                <div>
                  <h4 className="text-xs font-medium text-slate-400 mb-2">Befintligt avtal hos kunden</h4>

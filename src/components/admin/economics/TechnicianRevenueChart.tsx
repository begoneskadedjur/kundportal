const technicianData = getTechnicianData
  const totalRevenue = tech// 📁 src/components/admin/economics/TechnicianRevenueChart.tsx - BARA BEGONE DATA
...
const TechnicianRevenueChart: React.FC = () => {
  ...
  const getTechnicianData = useMemo((): TechnicianData[] => {
    ...
    const selectedIndex = allDates.findIndex(month => month === selectedMonth)
    if (selectedIndex === -1) {
    ...
    const startMonth = allDates[startIndex]
      ...
      <Card>
        ...
        <div className="h-80 flex items-center justify-center">
          <div className="flex flex-col items-center gap-3">
            ...
            <p className="text-slate-400 text-sm">Laddar tekniker statistik...</p>
          </div>
        </div>
      </Card>
    )
      ...
      <Card>
        ...
        <div className="h-80 flex items-center justify-center text-slate-400">
          <div className="text-center">
            ...
            <p>Ingen teknikerdata tillgänglig för vald period</p>
          </div>
        </div>
      </Card>
    )

// src/components/admin/customers/record/ClassicCasesSection.tsx
//
// KLASSISKA ärendevyn — för alla kunder UTAN Rum nr. Rumskunder får den nya
// designen i CustomerCasesSection. Återställd oförändrad från git (42ee2dfd^).
...
export default function ClassicCasesSection({
  root,
  units,
  cases,
  inspections,

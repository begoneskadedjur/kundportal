...
// (glass-klassen ger grå overlay), inga piller. Renderas direkt i trädet som
// CustomerRevenueModal - Portal-containern har pointerEvents: none och egen
// flex-layout som krockar med den här layouten.

  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        {/* Badge */}
        {unreadCount > 0 && (
          <span className="absolute -top-0.5 -right-0.5 min-w-[18px] h-[18px] px-1 bg-red-500 text-[#fff] text-xs font-bold rounded-full flex items-center justify-center animate-pulse">
